...
# How many hours will you work in this period? 0
# You entered zero hours for the period. Was that right?
# Type Yes or No
# No
...
def input_gross_income():
    ...
    """
    gross_income = 0.0
    gross_income = valid.get_real("What is your gross income for the time "
                               "period? \nS")
    return gross_income
...
def hours_decision(hours_worked, gross_income):
    ...
    if hours_worked == 0:
        ...
        yes_or_no = valid.get_y_or_n("Type Yes or No\n")
        if yes_or_no == "y":
            return
        elif yes_or_no == "n":
